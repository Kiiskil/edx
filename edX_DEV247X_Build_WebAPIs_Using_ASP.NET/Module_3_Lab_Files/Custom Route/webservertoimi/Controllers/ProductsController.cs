...
namespace WebServer.Controllers {
    ...
    [Route("api/[controller]")] //this takes name of controller as "arg". Can be random for security reasons
    //[Route("api/inventories")]
    public class ProductsController : Controller {

        //[HttpGet]
        [HttpGet("all")] 
        //[HttpGet, Route("all")] one before this and this are essentially the same thing
        public Product[] Get() {
